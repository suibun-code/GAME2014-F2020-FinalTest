...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.CompareTag("Shrinking Platform"))
        {
            ...
            other.gameObject.GetComponent<ShrinkingPlatformController>().audioSourceShrink.Play();
            transform.SetParent(other.gameObject.transform);
        }
    }
    ...
    private void OnCollisionExit2D(Collision2D other)
    {
        ...
        if (other.gameObject.CompareTag("Shrinking Platform"))
        {
            ...
            other.gameObject.GetComponent<ShrinkingPlatformController>().audioSourceEnlarge.Play();
            transform.SetParent(parent);
        }
    }
